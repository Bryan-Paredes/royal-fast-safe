...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  pathWidth = 2,
  pathOpacity = 0.3,
  gradientStartColor = "#b29e40",
  gradientStopColor = "#997f35",
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex h-12 w-12 items-center justify-center rounded-full border-2 bg-white p-1 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
